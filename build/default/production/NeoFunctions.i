...
const int NeoNum = 210;
volatile unsigned char BT_RC[5];
volatile unsigned char BT_Patron;
volatile unsigned char BT_Tiempo;
volatile unsigned char BT_Buff =0;
volatile unsigned char BT_RGB[3];
volatile __bit BT_rainbow;
...
void Show(void){
    ...
    _delay((unsigned long)((150)*(48000000/4000000.0)));
}
void setAll(unsigned char Red, unsigned char Green, unsigned char Blue){
